...
const TodoList = () => {
    ...
    const todos = [
        ...
        { id: 4, text: 'เคลียร์งานและเตรียมเก็บของ', completed: false },
        { id: 5, text: 'จองรถกลับบ้าน', completed: false },
        { id: 6, text: 'ไปธุระข้างนอก', completed: false },
        { id: 7, text: 'ซื้อของเข้าหอ', completed: false }
    ];
